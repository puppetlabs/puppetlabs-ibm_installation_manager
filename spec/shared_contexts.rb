...
shared_context :global_hiera_data do
  let(:hiera_data) do
     {
       #"ibm_installation_manager::deploy_source" => '',
       #"ibm_installation_manager::group" => '',
       #"ibm_installation_manager::options" => '',
       #"ibm_installation_manager::source" => '',
       #"ibm_installation_manager::source_dir" => '',
       #"ibm_installation_manager::target" => '',
       #"ibm_installation_manager::timeout" => '',
       #"ibm_installation_manager::user" => '',
